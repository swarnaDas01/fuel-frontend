import { useDeleteNotificationMutation } from "@/Store/slices/fuelStation";
import { toast } from "react-toastify";
import moment from 'moment';
import { useGetAllSupplierNotificationQuery } from "@/Store/slices/supplier";



export default function Suppliernotify() {
    const { data, isLoading, isError } = useGetAllSupplierNotificationQuery();
    ...
    if (isError) {
        return <div className="bg-gray-200 p-4 text-gray-900">Error occurred while fetching data...</div>;
    }
    const comments = data || [];
